...
unsup_pipeline = [
    ...
    dict(type='MultiBranch3D',
         branch_field=branch_field,
         unsup=dict(type='Pack3DDetInputs',
                    keys=['points', 'pts_semantic_mask'])),
]
...
labeled_dataset = dict(
    ...
    ignore_index=19,
    backend_args=backend_args,
    ann_file='semantickitti_infos_train.ple.1.pkl'
)
unlabeled_dataset = dict(
    ...
    ignore_index=19,
    backend_args=backend_args,
    ann_file='semantickitti_infos_train.ple.1-unlabeled.pkl',
)

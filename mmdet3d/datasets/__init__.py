...
# Newly added dataset
from .semantickitti_dataset_frame import SemanticKittiPoseDataset
from .semantickitti_dataset_two import SemanticKittiTwoDataset
from .nuscenes_seg_dataset import NuScenesSegDataset
from .nuscenes_kitti_dataset import NuScenesKiTTIDataaset
...
__all__ = [
    ...
    'SemanticKittiTwoDataset',
    # 'SemanticKittiPoseDataset'

    'NuScenesKiTTIDataaset',
    'NuScenesSegDataset',
